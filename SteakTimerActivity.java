...
*/				counter.start();
		...
		spnrSize.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
			public void onItemSelected(AdapterView<?> adapterView, View view,
					int i, long l) {
				SteakSize = i;
				final Button StrtButton = (Button) findViewById(R.id.StartTimerButton);
	...
	public class MyCount extends CountDownTimer {
		...
		MediaPlayer DoneAudioPlayer = MediaPlayer.create(
				getApplicationContext(), R.raw.timerdone);
		...
		public void onFinish() {
			...
			if (CurrentSide == 2) {
				...
				mTextView
						.setText("Allow 3-5 minutes resting time before serving.\nApply finishing sauce or glaze if desired.");
			}
		}

		@Override
		public void onTick(long millisUntilFinished) {
			mTextView.setText("Time Remaining: "
